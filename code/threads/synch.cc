...
void Semaphore::P()
{
    ...
    while (value == 0)
    {                                 // semaphore not available    while 可以换成 if 吗？
...
{
    Thread *helper = kernel->threadManager->createThread("ping");
